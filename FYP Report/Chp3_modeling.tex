...
from Pen-and-Paper Proofs (PP) to a Formal Proof (FP) representation that is machine-readable and logically well-formed, but not yet fully proved.
...
From an informal perspective, $\alpha(x)$ reflect how sensitive the total weight is to the choice of $w(x)$.
